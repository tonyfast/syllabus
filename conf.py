...
copyright = '2021'
exclude_patterns = ['**.ipynb_checkpoints', '.DS_Store', '.pytest_cache', 'Thumbs.db', 'Untitled*', '_build', 'jupyter_execute', 'old']
execution_allow_errors = False
execution_excludepatterns = []
execution_in_temp = False
execution_timeout = 30
extensions = ['sphinx_togglebutton', 'sphinx_copybutton', 'myst_nb', 'jupyter_book', 'sphinx_thebe', 'sphinx_comments', 'sphinx_external_toc', 'sphinx.ext.intersphinx', 'sphinx_panels', 'sphinx_book_theme', 'sphinx_sitemap', 'sphinx.ext.napoleon', 'sphinx.ext.todo', 'sphinx.ext.autodoc', 'sphinx.ext.viewcode', 'sphinx-jsonschema', 'jupyterbook_latex']
